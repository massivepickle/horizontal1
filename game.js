class Game{
    ...
    play(){
        ...
        if(allPlayer !== undefined){
            ...
            for(var plr in allPlayer){
                ...
                if(index === player.index){
                    ...
                    stroke(30);
                    fill("red");
                    ellipse(x+5,cars[index-1].y-15,20,20);
        ...
        if(keyIsDown(LEFT_ARROW) && player.index !== null && player.distance > 0){
            player.distance -= 50;
            player.update();        
        }
        if(player.distance >= 8350 || player.distance === null){
            gamestate = 2;
        }
        ...
        if(player.distance >= 8350){
            ...
            player.update();
            var rem = database.ref('players/player'+player.index);
            rem.remove();*/
